package com.rfachrur.wowbuku.activity;
...
import com.rfachrur.wowbuku.adapter.BukuAdapter;
import com.rfachrur.wowbuku.adapter.BukuRealmAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BukuRealmController.with(this).refresh();
        // get all persisted objects
        // create the helper adapter and notify data set changes
        // changes will be reflected automatically
        setRealmAdapter(BukuRealmController.with(this).getBooks());
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (editTitle.getText() == null || editTitle.getText().toString().equals("") || editTitle.getText().toString().equals(" ")) {
                                    ...
                                    recycler.scrollToPosition(BukuRealmController.getInstance().getBooks().size() - 1);
                                }
                            }
                        })
    ...
    public void setRealmAdapter(RealmResults<Buku> books) {

        BukuRealmAdapter realmAdapter = new BukuRealmAdapter(this.getApplicationContext(), books, true);
